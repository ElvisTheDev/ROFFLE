      ...
      >
        <div className="premium-header">
          ...
          <div className="premium-header-center">
            <div className="premium-title">👑Buy VIP Status</div>
        ...
        <div className="premium-body">
          <div className="premium-table">
            ...
            <div className="premium-table-header">
              ...
              {tierDefs.map((def) => (
                <div key={def.key} className="ptc value-cell tier-name-cell">
                  {def.short}
                </div>
              ))}
            </div>
            ...
            <div className="premium-table-row striped">
              ...
              {tierDefs.map((def) => (
                <div key={def.key} className="ptc value-cell">
                  <span className={`tier-pill ${def.key}`}>{def.badge}</span>
                </div>
              ))}
            </div>
            ...
            <div className="premium-table-row">
              ...
              {tierDefs.map((def) => (
                <div key={def.key} className="ptc value-cell">
                  <span className="stat-label">Regeneration Speed: </span>
                  <span className="stat-value">{def.regen}</span>
                </div>
              ))}
            </div>
            ...
            <div className="premium-table-row striped">
              ...
              {tierDefs.map((def) => (
                <div key={def.key} className="ptc value-cell">
                  <span className="stat-label">Wheel Round Limits: </span>
                  <span className="stat-value">{def.cap}</span>
                </div>
              ))}
            </div>
            ...
            <div className="premium-table-row">
              ...
              {tierDefs.map((def) => (
                <div key={def.key} className="ptc value-cell">
                  <span className="stat-label">Wheel Prize Multiplier: </span>
                  <span className="stat-value">{def.mult}</span>
                </div>
              ))}
            </div>
            ...
            <div className="premium-table-row striped">
              ...
              {tierDefs.map((def) => (
                <div key={def.key} className="ptc value-cell">
                  <span className="stat-label">Friends Invite Rewards: </span>
                  <span className="stat-value">{def.invites}</span>
                </div>
              ))}
            </div>
            ...
            <div className="premium-buy-row">
              <div className="ptc label-cell">Buy</div>
              {tierDefs.map((def) => {
                ...
                return (
                  <div key={def.key} className="ptc value-cell buy-cell">
                    <div className="buy-buttons">
                      {/* TON button */}
                      <button
                        className="btn-tier-ton"
                        disabled={disabled}
                        onClick={() => !disabled && handleBuyTierTon(def.key)}
                      >
                        {def.key === tierKey || isLowerOrEqual ? (
                          <span>{def.key === tierKey ? "Current Plan" : "N/A"}</span>
                        ) : (
                          <span className="btn-ton-inner">
                            <img
                              src="/ton-icon.png"
                              alt="TON"
                              className="ton-icon"
                      ...
                      <button
                        ...
                        disabled={disabled}
                        onClick={() => !disabled && handleBuyTierStars(def.key)}
                      >
                        {def.key === tierKey || isLowerOrEqual ? (
                          <span>{def.key === tierKey ? "Current Plan" : "N/A"}</span>
                        ) : (
